...
* `safeNet.writeTableAsync(function callback, number maxQuota or nil, any ...)` Write a table asynchronously. If maxQuota is nil, `math.min(quotaMax() * 0.75, 0.004)` will be used.
...
* `safeNet.writeTypeAsync(function callback, number maxQuota or nil, any ...)` Write a type or varargs asynchronously. If maxQuota is nil, `math.min(quotaMax() * 0.75, 0.004)` will be used.
